...
export const WORKSPACE_PIECES: readonly PieceManifest[] = [
  ...
  {
    id: "workspace.sourcing-pricing",
    nameCopyId: "component-browser.pricing-title",
    devIds: ["component-browser.pricing", "component-browser.offers-all"],
    dataNeeds: [
      "dossier.supplySummary.bestUnitPrice",
      "dossier.supplySummary.bestUnitPriceCurrency",
      "dossier.supplySummary.bestUnitPriceProvider",
      "dossier.supplySummary.factoryLeadTime",
      "dossier.distributorOffers",
    ],
    actions: ["component-browser.view-price-breaks"],
    scroll: { owns: false },
    home: { regionId: WORKSPACE_REGION.sourcingBody, siblingGroup: GROUP.sourcingSections },
    source: SOURCING_SOURCE,
  },
