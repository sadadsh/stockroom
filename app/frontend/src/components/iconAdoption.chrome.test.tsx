...
const IDENTICAL: Array<{ name: string; el: React.ReactElement; svg: string }> = [
  ...
  },
  {
    ...
    svg:
      '<svg class="ico h-5 w-5 flex-none text-t1" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' +
  ...
  },
  {
    ...
    svg:
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="h-3 w-3 text-t3" aria-hidden="true">' +
