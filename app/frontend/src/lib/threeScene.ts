...
export function mountModelScene(
  ...
  loader.parse(
    ...
    (gltf) => {
      ...
      // KiCad/STEP models are authored Z-up; three.js is Y-up, so -90° about X stands them
      // upright. Applied before framing so the auto-spin turns it about its own vertical axis.
