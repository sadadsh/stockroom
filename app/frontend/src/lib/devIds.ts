...
export const DEV_IDS: DevIdEntry[] = [
  ...
  { id: "settings.update-apply", label: "Install And Restart button", area: "settings" },
...
export const DEV_ID_AREAS: readonly string[] = ["rail", "about", "components", "detail", "search", "addpart", "ingest", "settings", "altiumdb", "complete", "preview", "diff", "confirm", "shell"];
