...
export const DEV_IDS: DevIdEntry[] = [
  ...
  { id: "detail.inspection", label: "Unified component inspection instrument", area: "detail" },
  { id: "detail.inspection-stage", label: "Shared symbol, footprint, and model stage", area: "detail" },
  { id: "detail.inspection-expand", label: "Expand or close component inspection", area: "detail" },
  { id: "detail.inspection-footer", label: "Inspection visibility status", area: "detail" },
  ...
  { id: "preview.tab-symbol", label: "Symbol inspection tab", area: "preview" },
  { id: "preview.tab-footprint", label: "Footprint inspection tab", area: "preview" },
  { id: "preview.tab-model", label: "3D inspection tab", area: "preview" },
