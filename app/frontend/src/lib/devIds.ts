...
export const DEV_IDS: DevIdEntry[] = [
  ...
  { id: "detail.asset-hero-open", label: "Inspect the 3D model from its stage overlay", area: "detail" },
  { id: "detail.asset-symbol-open", label: "Inspect the symbol from its stage overlay", area: "detail" },
  { id: "detail.asset-footprint-open", label: "Inspect the footprint from its stage overlay", area: "detail" },
